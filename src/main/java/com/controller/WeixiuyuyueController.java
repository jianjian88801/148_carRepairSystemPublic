...
public class WeixiuyuyueController {
    ...
    public R page(@RequestParam Map<String, Object> params,WeixiuyuyueEntity weixiuyuyue, 
		...
		if(tableName.equals("kehu")) {
			weixiuyuyue.setKehuzhanghao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,WeixiuyuyueEntity weixiuyuyue, HttpServletRequest request){
        EntityWrapper<WeixiuyuyueEntity> ew = new EntityWrapper<WeixiuyuyueEntity>();
		PageUtils page = weixiuyuyueService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, weixiuyuyue), params), params));
        return R.ok().put("data", page);
    }
    ...
    public R save(@RequestBody WeixiuyuyueEntity weixiuyuyue, HttpServletRequest request){
    	weixiuyuyue.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<WeixiuyuyueEntity> wrapper = new EntityWrapper<WeixiuyuyueEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = weixiuyuyueService.selectCount(wrapper);
